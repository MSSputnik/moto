...
url_paths = {
    ...
    r"{0}/accounts/(?P<account_id>[\d]+)/search/data-sources": QuickSightResponse.dispatch,
    r"{0}/accounts/(?P<account_id>[\d]+)/data-sources/(?P<datasourceid>[^/]+)": QuickSightResponse.dispatch,
    r"{0}/accounts/(?P<account_id>[\d]+)/data-sources/(?P<datasourceid>[^/]+)/permissions": QuickSightResponse.dispatch,
}
